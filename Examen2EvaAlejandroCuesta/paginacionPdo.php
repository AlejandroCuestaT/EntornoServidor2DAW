<?php
    ...
    function paginacion($conn, $query){
        ...
        //Devuelve Array con:
        //datos --> Resultado con el limite puesto (ahora es un objeto PDOStatement)
...
function pintarListadoCompleto($listaPaginaActual) {
    ...
    // Variable para los titulos de la cabecera usando PDO
    ...
    if ($primeraFila) {
        ...
        //Pintamos los valores del array devuelto de funcionPaginacion con el limite de filas usando PDO
