...
<div class="menu">
    ...
    <ul>
        <?php if ($rol === 'CLIENTE'): ?>
            <li><a href="nueva_reserva.php">Nueva Reserva (Cálculo de Fechas)</a></li>
            <li><a href="cancelar_reserva.php">Mis Reservas (Cancelar con DELETE)</a></li>
            <li><a href="mi_historial_gastos.php">Mi Historial de Gastos (SUM)</a></li>
        <?php endif; ?>

        <?php if ($rol === 'ADMIN'): ?>
            <li><a href="modificar_precios.php">Gestión de Flota (UPDATE Precios)</a></li>
            <li><a href="eliminar_cliente.php">Eliminar Cliente (Excepciones BD)</a></li>
        <?php endif; ?>
        
        <li><a href="estadisticas_flota.php">Informe Estadístico (AVG, MAX, COUNT)</a></li>
    </ul>
